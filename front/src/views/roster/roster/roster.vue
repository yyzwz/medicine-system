        ...
        <Card>
            <Row v-show="openSearch" @keydown.enter.native="handleSearch">
                <Form ref="searchForm" :model="searchForm" inline :label-width="60">
                    <Form-item label="姓名">
                        <Input type="text" v-model="searchForm.name" clearable @on-change="selectByNameFx" placeholder="请输入搜索的姓名" style="width: 160px" />
                    </Form-item>
                    <Form-item label="身份证">
                        <Input type="text" v-model="searchForm.identity" clearable placeholder="请输入搜索的身份证" style="width: 160px" />
                    </Form-item>
            ...
            <Row>
                <Table height="300" style="width: 100%;" :loading="loading" border :columns="columns" :data="data" sortable="custom" @on-sort-change="changeSort" @on-selection-change="showSelect" @on-row-click="handleRow" highlight-row ref="table"></Table>
            </Row>
            <Row type="flex" justify="end" class="page">
                <Page :current="searchForm.pageNumber" :total="total" :page-size="searchForm.pageSize" @on-change="changePage" @on-page-size-change="changePageSize" :page-size-opts="[5,10,20,30,50]" size="small" show-total show-elevator show-sizer></Page>
            </Row>
        </Card>
        </Col>
