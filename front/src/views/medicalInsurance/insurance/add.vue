         ...
         <Row :gutter="32">
            ...
            <Col span="12" >     
              <FormItem label="一类药报销百分比">
                <InputNumber v-model="form.one" clearable max="100" min="0"
                :formatter="value => `${value}%`"
                :parser="value => value.replace('%', '')"/>
              </FormItem>
            </Col>
            <Col span="12" >     
              <FormItem label="二类药报销百分比">
                <InputNumber v-model="form.two" clearable max="100" min="0"
                :formatter="value => `${value}%`"
                :parser="value => value.replace('%', '')"/>
              </FormItem>
            </Col>
            <Col span="12" >     
              <FormItem label="三类药报销百分比">
                <InputNumber v-model="form.three" clearable max="100" min="0"
                :formatter="value => `${value}%`"
                :parser="value => value.replace('%', '')"/>
              </FormItem>
            </Col>
