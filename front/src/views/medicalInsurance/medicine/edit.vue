...
<div>
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            <Row :gutter="32">
                <Col span="12">
                <FormItem label="手术名称" prop="name">
                    <Input v-model="form.name" clearable />
                </FormItem>
                </Col>
                <Col span="12">
                <FormItem label="手术价格" prop="price">
                    <Input v-model="form.price" clearable />
                </FormItem>
                </Col>
                <Col span="12">
                <FormItem label="手术类型" prop="type">
                    <Select v-model="form.type">
                        <Option v-for="(item, i) in this.$store.state.dict.medicineType" :key="i" :value="item.value">{{item.title}}</Option>
                    </Select>
                </FormItem>
                </Col>
                <Col span="12">
                <FormItem label="功能主治" prop="efficacy">
                    <Input v-model="form.efficacy" clearable />
                </FormItem>
                </Col>
            </Row>
            <Form-item class="br">
