        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
          <Form ref="searchForm" :model="searchForm" inline :label-width="70">
              <Form-item label="名称" prop="name">
                <Input type="text" v-model="searchForm.name" placeholder="请输入手术名称" clearable style="width: 200px"/>
              </Form-item>
              <Form-item label="功能主治" prop="efficacy">
                <Input type="text" v-model="searchForm.efficacy" placeholder="请输入功能主治" clearable style="width: 200px"/>
              </Form-item>
