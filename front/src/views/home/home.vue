...
.background1{
  background-image:url("https://changjienongye.cn/bs/homeImages/img1.jpg")
}
.background2{
  background-image:url("https://changjienongye.cn/bs/homeImages/img2.jpg")
}
.background3{
  background-image:url("https://changjienongye.cn/bs/homeImages/img3.jpg")
}
</style>
                ...
                <ul class="slides">
                    <li class="background1">
                        <div class="text center">
                            <h1 class="heading center white margin-bottom-small flex-animation">城乡居民大病保险管理系统<br>-</h1>
                            <p class="heading white center margin-bottom flex-animation">网络1701 唐倩</p>
                    ...
                    <li class="background2">
                        <div class="text center">
                            <h1 class="heading center white margin-bottom-small flex-animation no-opacity">城乡居民大病保险管理系统<br>-</h1>
                            <p class="heading white center margin-bottom flex-animation no-opacity">网络1701 唐倩</p>
                            <p class="heading white center margin-bottom flex-animation">本次登录地点:{{city}}</p>
