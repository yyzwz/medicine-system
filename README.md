...
- SpringBoot 2.7.0
- MybatisPlus 3.5.2(后端连数据库)
- SpringSecurity（系统认证、授权）
...
本项目是一个基于 **Vue** 和 **SpringBoot** 的城乡居民大病保险管理系统，模拟了就医和医保报销的过程，主要包含五大模块。
...
从 22 年 5 月开始，我给这个项目录制了一套视频课程，讲解如何在开发模板基础上，零基础开发这个项目。
