...
![输入图片说明](https://artskyhome.com/zwz/1.png)
...
![输入图片说明](https://artskyhome.com/zwz/3.png)

如果用户账号密码填写错误，系统给与提示，直到输入正确通过系统效验。

![输入图片说明](https://artskyhome.com/zwz/4.png)

如果用户输入错误的验证码，系统也会给与提示，要求重新输入

![输入图片说明](https://artskyhome.com/zwz/5.png)
...
![输入图片说明](https://artskyhome.com/zwz/7.png)

可以点击左侧滑动的按钮，进行切换图片操作

![输入图片说明](https://artskyhome.com/zwz/8.png)
...
![输入图片说明](https://artskyhome.com/zwz/9.png)

出现修改密码弹框，用户可以再次输入自己的新密码，完成账户密码修改。

![输入图片说明](https://artskyhome.com/zwz/10.png)

## 用户管理模块

登入成功后，有权限的用户可以进入登入用户管理模块。

![输入图片说明](https://artskyhome.com/zwz/11.png)

用户可以点击“添加用户”按钮，在弹框中完成用户的添加。

![输入图片说明](https://artskyhome.com/zwz/12.png)

点击每一行的编辑按钮，可以对用户信息进行编辑。

![输入图片说明](https://artskyhome.com/zwz/13.png)

点击每一行的启用/禁用按钮，可以对用户信息进行启用/禁用。

![输入图片说明](https://artskyhome.com/zwz/14.png)

点击每一行的删除按钮，可以对用户进行删除操作。

![输入图片说明](https://artskyhome.com/zwz/15.png)

V1.1.0 新增部门和员工的对应模块

![输入图片说明](https://artskyhome.com/zwz/16.png)
...
![输入图片说明](https://artskyhome.com/zwz/17.png)

管理员可以点击“添加角色”按钮，完成角色的添加。

![输入图片说明](https://artskyhome.com/zwz/18.png)

管理员可以点击每一行的“菜单权限”按钮，完成对角色的菜单权限分配。

![输入图片说明](https://artskyhome.com/zwz/19.png)

管理员可以点击每一行的“编辑”按钮，完成对角色数据的更新。

![输入图片说明](https://artskyhome.com/zwz/20.png)

管理员可以点击每一行的“设置默认”按钮，将角色设置为默认角色，新用户自动会赋予该角色。

![输入图片说明](https://artskyhome.com/zwz/21.png)

## 系统菜单模块

系统菜单模块用于控制系统菜单的代码位置、图表、模块名称等信息，该模块功能面向开发者。

![输入图片说明](https://artskyhome.com/zwz/22.png)

## 数据字典模块

该模块用户存放下拉框的常用数据，完成快捷开发。

![输入图片说明](https://artskyhome.com/zwz/23.png)

管理员可以添加数据字典，需要和代码中的字段进行匹配。

![输入图片说明](https://artskyhome.com/zwz/24.png)

管理员可以对数据字典下的数据值进行编辑操作。

![输入图片说明](https://artskyhome.com/zwz/25.png)
...
![输入图片说明](https://artskyhome.com/zwz/29.png)
...
![输入图片说明](https://artskyhome.com/zwz/30.png)
...
![输入图片说明](https://artskyhome.com/zwz/31.png)
...
![输入图片说明](https://artskyhome.com/zwz/38.png)

如果保险审核员对于申请的医保报销无法进行通过，则可以点击“退回”，输入退回的原因：该病不予报销，点击“确定”，则可以退回申请。

![输入图片说明](https://artskyhome.com/zwz/39.png)

如果某个医保保险申请符合要求，则可以审核通过，点击“审核通过”按钮，再点击“确认”即可。

![输入图片说明](https://artskyhome.com/zwz/40.png)

## 医疗设备档案模块【V1.1.0 新增】

医疗资产品类模块如下所示。

![输入图片说明](https://artskyhome.com/zwz/41.png)

资料资产入库模块如下所示。

![输入图片说明](https://artskyhome.com/zwz/42.png)

入库单主界面如下图所示。

![输入图片说明](https://artskyhome.com/zwz/43.png)

医疗资产出库操作界面如下图所示。

![输入图片说明](https://artskyhome.com/zwz/44.png)

出库单主界面如下图所示。

![输入图片说明](https://artskyhome.com/zwz/45.png)
...
![输入图片说明](https://artskyhome.com/zwz/46.png)

3. 使用 VsCode 打开前端项目目录，新建终端，输入 npm i 安装依赖，后输入 npm run dev 运行项目。

![输入图片说明](https://artskyhome.com/zwz/47.png)

![输入图片说明](https://artskyhome.com/zwz/48.png)

4. 使用 Idea 打开后端项目目录，检查 Maven 配置和 JDK 配置是否正常。

![输入图片说明](https://artskyhome.com/zwz/49.png)

5. 检查后端数据库配置是否符合开发环境要求。

![输入图片说明](https://artskyhome.com/zwz/50.png)

6. 启动后端项目。

![输入图片说明](https://artskyhome.com/zwz/51.png)
